...
*/
int RPG::getDiceRoll(int maxValue) { // 2k3 function that gets a random number from 1 to maxValue
	int out;
...
*/
void RPG::openMenu(RPG::MenuSubScreen screen, int heroId, int skillOrItemId) {
